...
This project implements a simple recursive algorithm in C++. The algorithm returns the sum of the values of a given array.
...
1. **Clone the Repository:**
   ...
   cd divide-and-conquer/recursive-sum/c++
   ```
